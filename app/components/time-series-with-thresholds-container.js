...
export default class TimeSeriesWithThresholdsContainerComponent extends Component {
  d3Config = {
    chartElementSelector: '#time-series-with-thresholds-container',
    viewportHeight: 400,
    viewportWidth: 900,
